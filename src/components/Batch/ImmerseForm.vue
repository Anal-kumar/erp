...
const fetchImmerse = async () => {
  try {
    const response = await axios.get(
      `${config.apiBaseUrl}/api/${config.version}/immerses/get_immerses`,
      {
        headers: { Authorization: `Bearer ${sessionStorage.getItem('token')}` },
      },
    );
...
const submitForm = async () => {
  ...
  try {
    ...
    const response = await axios.post(
      `${config.apiBaseUrl}/api/${config.version}/immerses/create_immerse`,
      payload,
      {
        headers: { Authorization: `Bearer ${sessionStorage.getItem('token')}` },
      },
...
const UpdateForm = async () => {
  ...
  try {
    ...
    const response = await axios.put(
      `${config.apiBaseUrl}/api/${config.version}/immerses/update_immerse/${selectImmerseId.value}`,
      payload,
      {
        headers: { Authorization: `Bearer ${sessionStorage.getItem('token')}` },
      },
